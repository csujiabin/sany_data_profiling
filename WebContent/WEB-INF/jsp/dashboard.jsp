...
<head>
    ...
    <!-- <script src="sb-admin-2/bower_components/raphael/raphael-min.js"></script>
    <script src="sb-admin-2/bower_components/morrisjs/morris.min.js"></script>
    <script src="sb-admin-2/js/morris-data.js"></script> -->
