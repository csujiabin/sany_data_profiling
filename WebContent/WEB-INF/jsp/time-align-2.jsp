            ...
            $.ajax({
                ...
                success : function(responseJson) {
                    ...
                    $.each(responseJson, function(index, equip) {
                        $("#left-select").append($("<option>").text(equip));
                    });
                }
            });
        });
                                ...
                                <div class="col-lg-24">
                                    <form role="form" action="goAlignResult" method="post">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group form-group-lg">
                                                    ...
                                                    <select id="left-select" multiple class="form-control" size="15" 
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group form-group-lg">
                                                    ...
                                                    <select id="right-select" name="equipList" multiple class="form-control" size="15"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <a href="time-align"><button type="button" class="btn btn-info btn-block">上一步</button></a>
                                            </div>
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3">
                                                <button type="submit" class="btn btn-primary btn-block">提交所有设备</button>
                                            </div>
                                            <div class="col-lg-3">
                                                <button type="submit" class="btn btn-success btn-block">提交已选设备</button>
                                            </div>
                                            <div class="col-lg-0">
                                            </div>
                                        </div>
