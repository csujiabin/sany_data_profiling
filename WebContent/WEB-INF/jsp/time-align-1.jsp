                                ...
                                <div class="col-lg-24">
                                    <form role="form" action="goEquipSelection" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group form-group-lg">
                                                    ...
                                                    <select id="right-select" name="paraList" multiple class="form-control" size="15"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <button type="reset" class="btn btn-warning btn-block" onclick="clearSelect(document.getElementById('right-select'))">重置</button>
                                            </div>
                                            <div class="col-lg-3">
